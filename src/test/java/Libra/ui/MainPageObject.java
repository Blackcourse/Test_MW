...
public class MainPageObject {
    ...
    public boolean waitFormenutoRender(By by, String error_message, long timeoutInsecond) {
    ...
    public WebElement waitAndClear( String locator, String error_message, long timeoutInsecond) {
        WebElement element = waitForElementPresent(locator, error_message, timeoutInsecond);
        element.clear();
        return element;
    }

    public void swipeUp(int timeswipe) {
...
public boolean isElementLocatedOnTheScreen (String locator)
{
    ...
    return element_location_by_y < screen_size_by_y;
        ...
        if (driver instanceof AppiumDriver) {
            ...
            System.out.println("Method clickcorner does nothing for platform"+ Platform.getInstance().getPlatformVar ());
        }
    }
    ...
    {  if (driver instanceof AppiumDriver) {
        ...
        System.out.println("Method swipeelement does nothing for platform"+ Platform.getInstance().getPlatformVar ());
    }
    }
    ...
    public String waitforelementGetAtribute(String locator, String attribute, String error_message, long timeoutinseconds) {
